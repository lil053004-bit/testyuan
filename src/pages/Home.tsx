...
import FullWidthStockInfo from '../components/FullWidthStockInfo';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {stockData && !loading && diagnosisState === 'initial' && (
          <div className="space-y-6">
            <FullWidthStockInfo info={stockData.info} />
        ...
        {(diagnosisState === 'connecting' || diagnosisState === 'processing') && (
          <div className="py-20">
        ...
        <DiagnosisModal
          isOpen={diagnosisState === 'connecting' || diagnosisState === 'processing' || diagnosisState === 'streaming' || diagnosisState === 'results'}
          onClose={closeModal}
          analysis={analysisResult}
          stockCode={stockCode}
          stockName={stockData?.info.name || ''}
