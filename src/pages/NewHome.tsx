...
import DarkBlueBackground from '../components/DarkBlueBackground';
import AiLogo3D from '../components/AiLogo3D';
import FullWidthStockInfoCard from '../components/FullWidthStockInfoCard';
...
import EnhancedDiagnosisButton from '../components/EnhancedDiagnosisButton';
import RegistrationInfo from '../components/RegistrationInfo';
import PriceHistoryScroller from '../components/PriceHistoryScroller';
  ...
  return (
    <>
      ...
      <div className="relative min-h-screen flex flex-col">
        <Header isHidden={diagnosisState === 'streaming' || diagnosisState === 'results'} />
        <ApiStatsDisplay />

        <div className="relative z-10 max-w-[1400px] mx-auto px-6 sm:px-8 lg:px-12 py-8 flex-1">
          <AiLogo3D />
          ...
          {loading && (
            <div className="text-center py-20">
              <div className="inline-block animate-spin rounded-full h-16 w-16 border-4 border-blue-border/30 border-t-ai-blue"></div>
          ...
          {stockData && diagnosisState === 'preparing' && (
            <div className="space-y-6">
              ...
              <div className="max-w-2xl mx-auto py-8">
                <div className="bg-gradient-to-br from-slate-900/80 to-blue-900/80 backdrop-blur-xl rounded-2xl p-8 border border-blue-600/30 shadow-2xl">
                  <div className="flex flex-col items-center space-y-4">
                    ...
                    <div className="text-center space-y-2">
                      ...
                      <p className="text-sm text-blue-300/70">データを分析中</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-gradient-to-br from-slate-900/80 to-blue-900/80 backdrop-blur-xl rounded-2xl p-8 border border-blue-600/30 shadow-2xl">
                  <div className="flex flex-col items-center space-y-4">
                    ...
                    <div className="text-center space-y-2">
                      ...
                      <p className="text-sm text-blue-300/70">AIが分析しています</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {diagnosisState === 'error' && (
            <div className="text-center py-20">
              <div className="max-w-2xl mx-auto p-8 bg-navy-card/60 backdrop-blur-xl border border-red-600/30 rounded-2xl">
                ...
                <button
                  ...
                  className="px-8 py-3 bg-orange-gradient text-white font-bold rounded-lg hover:shadow-orange-glow transition-all shadow-lg"
                >
                  もう一度試す
                </button>
              </div>
        ...
        <ComplianceNotice isHidden={diagnosisState === 'streaming' || diagnosisState === 'results'} />
      </div>
    </>
  );
}
