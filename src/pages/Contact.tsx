            ...
            <div className="bg-slate-100 rounded-lg p-6">
              ...
              <div className="space-y-3 text-sm text-gray-700">
                <div className="flex items-start gap-2">
                  <span className="font-semibold min-w-[100px]">組織名：</span>
                  <span>合同会社リコッテ (Ricotte LLC)</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="font-semibold min-w-[100px]">担当者名：</span>
                  <span>田口哲夫</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="font-semibold min-w-[100px]">郵便番号：</span>
                  <span>536-8501</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="font-semibold min-w-[100px]">住所：</span>
                  <span>大阪府大阪市城东区野江一丁目13番4号</span>
                </div>
                <div className="flex items-start gap-2">
                  <Phone className="w-4 h-4 text-blue-600 mt-0.5" />
                  <div>
                    <span className="font-semibold">電話番号：</span>
                    <span className="ml-2">080-3824-1560</span>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <span className="ml-2 text-blue-600">qddqdd3316@gmail.com</span>
                  </div>
                </div>
              </div>
            </div>
