        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="prose max-w-none">
            ...
            <div className="bg-red-50 border-l-4 border-red-500 p-4 mb-6">
              <p className="text-red-900 font-bold mb-1 text-sm">重要な注意事項</p>
              <p className="text-red-800 leading-relaxed text-sm">
                当サービスは情報提供のみを目的としており、投資助言や投資勧誘を行うものではありません。投資判断はご自身の責任において行ってください。
              </p>
            </div>

            <section className="mb-6">
              <h2 className="text-lg font-bold text-gray-900 mb-3">1. サービスの性質について</h2>
            ...
            <section className="mb-6">
              <h2 className="text-lg font-bold text-gray-900 mb-3">2. 情報の正確性について</h2>
              <p className="text-gray-700 leading-relaxed text-sm mb-2">
            ...
            <section className="mb-6">
              <h2 className="text-lg font-bold text-gray-900 mb-3">3. 投資リスクについて</h2>
            ...
            <section className="mb-6">
              <h2 className="text-lg font-bold text-gray-900 mb-3">4. 投資判断の責任</h2>
              <p className="text-gray-700 leading-relaxed text-sm mb-2">
            ...
            <section className="mb-6">
              <h2 className="text-lg font-bold text-gray-900 mb-3">5. サービスの可用性</h2>
              <p className="text-gray-700 leading-relaxed text-sm mb-2">
            ...
            <section className="mb-6">
              <h2 className="text-lg font-bold text-gray-900 mb-3">6. 外部リンクについて</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="mb-6">
              <h2 className="text-lg font-bold text-gray-900 mb-3">7. 専門家への相談</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="mb-6">
              <h2 className="text-lg font-bold text-gray-900 mb-3">8. 本免責事項の変更</h2>
              <p className="text-gray-700 leading-relaxed">
