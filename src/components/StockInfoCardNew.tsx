...
export default function StockInfoCardNew({ info }: StockInfoCardNewProps) {
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="bg-[#001a4d]/60 backdrop-blur-sm border border-cyan-400/30 rounded-lg overflow-hidden">
        <div className="flex">
          <div className="flex-1 flex items-center justify-center border-r border-cyan-400/30 py-8 px-4">
            <div className="text-center">
              <div className="text-4xl font-bold text-white mb-2">{info.code}</div>
          ...
          <div className="flex-[2] py-4 px-4">
            <div className="grid grid-cols-2 gap-3 text-sm">
              <div className="text-center">
                ...
                <div className="text-white font-semibold">{info.price || '0'}</div>
              </div>
              <div className="text-center">
