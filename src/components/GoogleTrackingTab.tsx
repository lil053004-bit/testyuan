  ...
  if (loading) {
    return (
      <div className="text-center py-20">
        ...
        <p className="mt-4 text-slate-900 font-medium">加载追踪配置...</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-slate-700 mt-1">配置 Google Ads 和 Google Analytics 4 追踪代码</p>
      </div>
